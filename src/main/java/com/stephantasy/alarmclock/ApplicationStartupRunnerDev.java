...
//                    new Alarm("alarm 001", LocalDateTime.now().minusMinutes(1).withSecond(0), "Desc", new Recurrence(RecurrenceType.Once, new boolean[]{false, false, false, false, false, false, false}), 1, 1, false, true),
                    new Alarm("alarm alarm 002", LocalDateTime.now().plusMinutes(1).withSecond(0), "Desc", new Recurrence(RecurrenceType.EveryDay, new boolean[]{true, true, true, true, true, true, true}), 1, 1, false, true)//,
//                    new Alarm("alarm 003", LocalDateTime.now().plusMinutes(2).withSecond(0), "Desc", new Recurrence(RecurrenceType.EveryDay, new boolean[]{true, true, true, true, true, false, false}), 1, 1, false, false),
